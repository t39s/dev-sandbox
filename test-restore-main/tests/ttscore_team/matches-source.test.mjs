...
} from "../../team/assets/0.9.0/matches-source.mjs";
...
test("относительный reportUrl сохраняет прежнюю базу team/matches/<id>/", () => {
  const base = teamMatchResourceBaseUrl(
    "north-south-2026",
    "https://example.com/ttscore/team/assets/0.9.0/matches-source.mjs"
  );
...
test("публичный URL сохраняет страницу и заменяет параметры режима создания", () => {
  const url = publicTeamMatchUrl(
    "north-south-2026",
    "https://t39s.github.io/ttscore/team/ttscore_team_0.9.0.html?mode=create#form"
  );
  assert.equal(url.href, "https://t39s.github.io/ttscore/team/ttscore_team_0.9.0.html?match=north-south-2026");
});
