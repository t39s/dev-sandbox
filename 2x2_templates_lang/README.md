...
RC4 построен от manifest-verified RC3. Главное изменение RC4 — экран итогового отчёта приведён к визуальной композиции первоисточника `t39s/2x2`: классическая типографика, трёхколоночная таблица результатов, строки «Итого»/«Норматив» и компактные действия. Логика нового session/progress runtime сохранена.
